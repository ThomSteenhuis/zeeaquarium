...
try:
    while True:
        ...
        if True:
            ...
            if watervolume_topoff <= 0 or VOLUME_RESERVOIR < 2:
                continue
            
            time_topoff = 60 * watervolume_topoff / (VOLUME_RESERVOIR * (VOLUME_PM_20 - VOLUME_PM_10) / 10 + 2 * VOLUME_PM_10 - VOLUME_PM_20)
